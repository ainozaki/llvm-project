...
enum class AllocTokenMode {
  ...
  /// Token ID based on allocated type and function name hash.
  TypeFuncHash,

  /// Token ID based on allocated type and function name hash, where the top
  /// half ID-space is reserved for types that contain pointers and the bottom
...
/// modes that are only available in the AllocToken pass or when required
