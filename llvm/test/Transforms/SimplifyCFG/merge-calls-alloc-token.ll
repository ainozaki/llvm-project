...
define ptr @test_merge_alloc_token_sites(i1 %b) {
; CHECK-LABEL: define ptr @test_merge_alloc_token_sites(
; CHECK: call ptr @_Znwm(i64 4), !alloc_token [[META3:![0-9]+]]
entry:
  br i1 %b, label %if.then, label %if.else
